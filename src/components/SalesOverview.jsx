...
export function SalesOverview() {
  const vendasRecentes = [
    {
      id: "ORD-089",
      cliente: "PharmaBotanic",
      produto: "Óleo CBD Full Spectrum",
      qtd: "200 frascos",
      valor: "R$ 45.000",
      status: "Entregue",
    ...
    {
      id: "ORD-090",
      cliente: "Dispensário Green Leaf",
      produto: "Green Gelato (Flor Seca)",
      qtd: "5 kg",
      valor: "R$ 62.500",
      status: "Em Transporte",
      corStatus: "bg-blue-500/10 text-blue-400 border-blue-500/20"
    },
    {
      id: "ORD-091",
      cliente: "Clínica Vida Ativa",
      produto: "Charlotte's Web",
      qtd: "2 kg",
      valor: "R$ 18.000",
      status: "Processando",
  ...
  return (
    <section className="mt-8 flex flex-col lg:flex-row gap-6">
      ...
      >
        <Card className="bg-zinc-900/50 border-zinc-800 h-full backdrop-blur-sm">
            ...
            <div className="pt-4 border-t border-zinc-800/50 flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-zinc-400">
                  ...
                  <span className="text-sm">Volume Distribuído</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-zinc-400">
                  <Truck size={16} />
                  <span className="text-sm">Lotes em Rota</span>
                </div>
      ...
      {/* Lado Direito: Lista de Vendas Recentes */}
      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
            ...
            <div className="rounded-xl border border-zinc-800/60 overflow-hidden">
              ...
              <div className="divide-y divide-zinc-800/50">
                {vendasRecentes.map((venda, index) => (
                  <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4 items-center hover:bg-zinc-800/20 transition-colors">
                    <div className="md:col-span-2 font-mono text-xs text-zinc-500">
                      {venda.id}
                    </div>
                    <div className="md:col-span-3 font-medium text-zinc-200 text-sm">
                      {venda.cliente}
                    </div>
                    <div className="md:col-span-3 text-sm text-zinc-400">
                      {venda.produto} <span className="text-zinc-600 text-xs ml-1">({venda.qtd})</span>
                    </div>
                    <div className="md:col-span-2 text-right font-medium text-emerald-400 text-sm">
                      {venda.valor}
                    </div>
                    <div className="md:col-span-2 flex justify-start md:justify-center">
                      <Badge variant="outline" className={`${venda.corStatus} whitespace-nowrap`}>
                        {venda.status}
                      </Badge>
                    </div>
                  </div>
